...
(function () {
  ...
  function projectHref(project, index) { return index === 0 || project.name.indexOf('الفضيلة') > -1 ? 'هوميرا - مشروع الفضيلة 117.html' : 'هوميرا - المشاريع.html'; }
  function card(project, index) {
    var cover = project.cover || 'uploads/3.jpg';
    return '<a class="proj-card" data-cat="' + (project.type === 'فيلا' ? 'villa' : 'apart') + '" data-loc="' + project.dist + '" data-area="' + project.area + '" data-price="' + project.price + '" data-rooms="4" data-facade="' + project.facade + '" href="' + projectHref(project, index) + '">' +
